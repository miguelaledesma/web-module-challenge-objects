...
const newMenuItems = createMenuItem('Tacos', 8, 'Lunch'); 
...
*/
const newMenuItems2 = createMenuItem('pizza', 5, 'Lunch'); 
const newMenuItems3 = createMenuItem('Steak', 20, 'Dinner'); 
const newMenuItems4 = createMenuItem('Chocolate Cake', 9, 'Dessert'); 

console.log(newMenuItems2)
console.log(newMenuItems3)
console.log(newMenuItems4)
...
console.log(addReview(reviews, 'Daniela', 5, 'This resturant is great!'))
